...
import (
	...
	vm "github.com/cosmos/evm/x/vm/core/vm"
...
// GetParams mocks base method.
func (m *MockFeeMarketKeeper) GetParams(ctx types.Context) types2.Params {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetParams", ctx)
...
func (m *MockSubspace) GetParamSetIfExists(ctx types.Context, ps types3.LegacyParams) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "GetParamSetIfExists", ctx, ps)
}

// GetParamSetIfExists indicates an expected call of GetParamSetIfExists.
func (mr *MockSubspaceMockRecorder) GetParamSetIfExists(ctx, ps interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetAllBalances indicates an expected call of GetAllBalances.
func (mr *MockBankWrapperMockRecorder) GetAllBalances(ctx, addr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SpendableCoins mocks base method.
func (m *MockBankWrapper) SpendableCoins(ctx context.Context, addr types.AccAddress) types.Coins {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SpendableCoins", ctx, addr)
	ret0, _ := ret[0].(types.Coins)
	return ret0
...
// SpendableCoins indicates an expected call of SpendableCoins.
func (mr *MockBankWrapperMockRecorder) SpendableCoins(ctx, addr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SpendableCoins", reflect.TypeOf((*MockBankWrapper)(nil).SpendableCoins), ctx, addr)
}
